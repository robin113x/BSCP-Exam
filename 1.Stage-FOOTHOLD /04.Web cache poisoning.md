...
Cache Small, temporary storage that keeps frequently accessed data for quick retrieval.
Web-cache mean we are going to store the infioramtion of out web-service .
