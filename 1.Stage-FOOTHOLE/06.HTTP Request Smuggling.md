...
4. Confirm the CL.TE Vulnerability
    ...
    -   ## To Confirm, Send this payload to get valid response 
...
![alt text](https://raw.githubusercontent.com/robin113x/BSCP-Exam/refs/heads/main/Images/HttpRequest1.png)  
![alt text](https://raw.githubusercontent.com/robin113x/BSCP-Exam/refs/heads/main/Images/HttpRequest2.png) 



# 1.1 Checking if the front-end uses Transfer-Encoding 
```bash
POST / HTTP/1.1
Host: victim.com
...
# 1.2 Checking if the front-end uses Content-Length
```
POST / HTTP/1.1
Host: victim.com
Content-Type: application/x-www-form-urlencoded
...
# 2.1 Checking if the back-end uses Transfer-Encoding
```bash
POST / HTTP/1.1
Host: victim.com
Content-Type: application/x-www-form-urlencoded
...
# 2.2 Checking if Backend using Content-Length
```bash
POST / HTTP/1.1
Host: victim.com
Content-Type: application/x-www-form-urlencoded
