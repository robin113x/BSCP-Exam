...
--> Use feroxbuster to find  /backup/ProductTemplate.java.bak
    - feroxbuster -u https://0aea008304f8868380ae35d600eb00e3.web-security-academy.net/ -w $WORDLIST -t 50 --filter-status 403,404 -d 12 ::  /backup/ProductTemplate.java.bak
``` 